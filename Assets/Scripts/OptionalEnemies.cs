...
//
// Brief Description : This script is for enemies that fire a bit faster, but don't need to be defeated to progress to the next room.
**/
using Q3Movement;
using UnityEngine;
...
public class OptionalEnemies : MonoBehaviour
{
